...
public class BinaryConverter extends AppCompatActivity {
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.opton_normal_1:
                Intent intent =new Intent(BinaryConverter.this,HelpActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.binaryactivity);
